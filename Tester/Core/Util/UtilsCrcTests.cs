...
public class UtilsCrcTests {
    ...
    public void CalculateCrc_SingleByte_ReturnsDeterministicResult() {
        ...
        var (low2, high2) = Utils.CalculateCrc(packet);
        // 하위 바이트 일관성 확인
    ...
    public void CalculateCrcTo_KnownVector_WritesCrcToBuffer() {
        ...
        // 버퍼에 CRC 기록
        // write CRC to buffer
        Utils.CalculateCrcTo(packet, buffer);
    ...
    public void CalculateCrcTo_BufferTooSmall_ThrowsArgumentException() {
        ...
        Assert.Throws<ArgumentException>(() => Utils.CalculateCrcTo(packet, buffer));
    }
    ...
    public void ValidateCrc_ValidPacket_ReturnsTrue() {
        ...
        var result = Utils.ValidateCrc(packet);
    ...
    public void ValidateCrc_MinimumValidLength_WorksCorrectly() {
        ...
        // CRC 값 계산
        // compute CRC value
        var (low, high) = Utils.CalculateCrc(data);
        // CRC 포함 3바이트 패킷 구성
