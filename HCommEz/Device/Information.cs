...
namespace HCommEz.Device
{
    ...
    public class Information
    {
        ...
        public class CalInfo
        {
            ...
            {
                get => new List<int> { Positive1, Positive2, Positive3, Positive4, Positive5 };
                set
                {
                    // check value
                    if (value == null)
            ...
            {
                get => new List<int> { Negative1, Negative2, Negative3, Negative4, Negative5 };
                set
                {
                    // check value
                    if (value == null)
            ...
            public int Offset
            {
                get => Type == BodyTypes.Integration
    ...
    public enum BodyTypes
    {
        ...
        [Description(@"Built-out")] Separation
    }
    ...
    public enum AutoClearTypes
    {
        ...
        [Description(@"500ms")] MSec500,
        [Description(@"1 sec")] Sec1,
        [Description(@"2 sec")] Sec2,
        [Description(@"3 sec")] Sec3,
        [Description(@"4 sec")] Sec4,
        [Description(@"5 sec")] Sec5
    }
    ...
    public enum ModeTypes
    {
        ...
        [Description(@"First-Peak")] FirstPeak,
    ...
    {
        [Description(@"100 Hz")] Hz100,
        [Description(@"500 Hz")] Hz500,
        [Description(@"1500 Hz")] Hz1500,
        [Description(@"2000 Hz")] Hz2000,
        [Description(@"3000 Hz")] Hz3000
    }
